...
public class LaundryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(priceTxt);
        priceTxt.setBounds(640, 250, 200, 31);

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel9.setText("Laundry Booking Status");
        add(jLabel9);
        jLabel9.setBounds(640, 410, 280, 60);

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel3.setText("Category Name:");
        add(jLabel3);
        jLabel3.setBounds(460, 190, 150, 25);

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setText("Enter Number of clothes:");
        add(jLabel8);
        jLabel8.setBounds(380, 310, 240, 25);

        categoryNameTxt.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        add(categoryNameTxt);
        categoryNameTxt.setBounds(640, 190, 200, 31);

        numberOfClothesTxt.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        add(numberOfClothesTxt);
        numberOfClothesTxt.setBounds(640, 310, 200, 31);

        bookLaundryBtn.setBackground(new java.awt.Color(0, 0, 0));
        bookLaundryBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        add(bookLaundryBtn);
        bookLaundryBtn.setBounds(920, 250, 150, 50);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(120, 480, 1240, 300);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setText("Book Laundry");
        add(jLabel1);
        jLabel1.setBounds(660, 10, 200, 70);

        viewPriceBtn.setBackground(new java.awt.Color(0, 0, 0));
        viewPriceBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        viewPriceBtn.setForeground(new java.awt.Color(255, 255, 255));
        viewPriceBtn.setText("View Price");
        viewPriceBtn.setBorder(javax.swing.BorderFactory.createCompoundBorder());
        ...
        add(viewPriceBtn);
        viewPriceBtn.setBounds(920, 160, 150, 50);

        chooseLaundryDropdown.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        add(chooseLaundryDropdown);
        chooseLaundryDropdown.setBounds(640, 130, 200, 31);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel6.setText("Price per cloth:");
        add(jLabel6);
        jLabel6.setBounds(470, 250, 130, 25);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setText("Choose a category of your choice:");
        add(jLabel2);
        jLabel2.setBounds(310, 130, 310, 30);
