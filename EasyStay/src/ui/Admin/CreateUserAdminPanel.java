...
public class CreateUserAdminPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setLayout(null);
        add(txtAge);
        txtAge.setBounds(660, 510, 203, 23);

        jLabel2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel2.setText("User Name");
        add(jLabel2);
        jLabel2.setBounds(470, 280, 119, 22);

        jLabel14.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel14.setText("Email Address");
        add(jLabel14);
        jLabel14.setBounds(470, 560, 140, 22);

        jLabel3.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel3.setText("Last Name");
        add(jLabel3);
        jLabel3.setBounds(470, 230, 119, 22);
        add(txtEmailAddress);
        txtEmailAddress.setBounds(660, 560, 203, 23);

        jLabel4.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel4.setText("Password");
        add(jLabel4);
        jLabel4.setBounds(470, 330, 119, 22);

        jLabel5.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel5.setText("Roletype");
        add(jLabel5);
        jLabel5.setBounds(470, 380, 119, 22);

        jLabel1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel1.setText("First Name");
        add(jLabel1);
        jLabel1.setBounds(470, 190, 162, 22);
        add(txtAddress);
        txtAddress.setBounds(660, 420, 203, 23);
        add(txtFName);
        txtFName.setBounds(660, 180, 203, 23);
        add(txtPhoneNumber);
        txtPhoneNumber.setBounds(660, 470, 203, 23);
        add(txtLName);
        txtLName.setBounds(660, 230, 203, 23);

        jLabel8.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel8.setText("Address");
        add(jLabel8);
        jLabel8.setBounds(470, 420, 162, 22);
        add(txtUserName);
        txtUserName.setBounds(660, 280, 203, 23);

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setText("Age");
        add(jLabel10);
        jLabel10.setBounds(470, 520, 162, 22);
        add(txtPassword);
        txtPassword.setBounds(660, 320, 203, 23);

        jLabel11.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel11.setText("Phone Number");
        add(jLabel11);
        jLabel11.setBounds(470, 470, 162, 22);
        ...
        add(cmbRole);
        cmbRole.setBounds(660, 370, 203, 23);

        createUserBtn.setBackground(new java.awt.Color(0, 0, 0));
        createUserBtn.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
